...
export default function DashboardStats({
    ...
    return (
        <StyledCard sx={{ p: 2.5, height: '100%', borderRadius: 4 }}>
            <Typography variant="h6" gutterBottom fontWeight="bold" sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                <span>📊</span> {t('home:stats.title')}
            </Typography>

            {/* Mastery Progress */}
            <Box sx={{ mb: 2, p: 1.5, bgcolor: 'success.lighter', borderRadius: 2, background: 'linear-gradient(135deg, rgba(16,185,129,0.08) 0%, rgba(52,211,153,0.08) 100%)' }}>
